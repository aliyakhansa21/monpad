...
const buttonStyles = {
    primary: 'bg-primary text-white hover:bg-background-dark px-4 py-2',
    danger: 'bg-danger text-white hover:bg-danger px-4 py-2',
    ghost: 'bg-transparent text-gray-600 border-purple hover:border-background-dark p-1.5',
    ...
    cancel: 'bg-transparent text-gray-600 border-primary hover:bg-red-100',
};
