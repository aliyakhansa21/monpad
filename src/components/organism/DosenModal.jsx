            ...
            <DialogContent className="sm:max-w-[960px] md:max-w-xl lg:max-w-2xl">
                <DialogHeader>
                    <DialogTitle className="text-center text-primary font-bold text-3xl">
                        {mode === 'add' ? 'Tambah Dosen' : 'Perbarui Data Dosen'}
                    </DialogTitle>
                </DialogHeader>
                <form onSubmit={handleSubmit}>
                    <div className="grid gap-4 py-4 md:grid-cols-2">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 items-center gap-4">
                            <Label htmlFor="tahun_ajaran" className="md:text-center">NIDN</Label>
                            <div className="md:col-span-3">
                                <Input
                                id="nidn"
                                name="nidn"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 items-center gap-4">
                            <Label htmlFor="tahun_ajaran" className="md:text-center">FAKULTAS</Label>
                            <div className="md:col-span-3">
                                <Input
                                id="fakultas"
                                name="fakultas"
